        ...
        <body>
            ...
            <div className="container p-3 my-3 bg-dark text-white mx-auto text-center cadastro-content">
                ...
                <form action="../paginas/index.html">
                    ...
                    <div className="form-group">
                        <label for="enunciado">Tipo De Usuário: </label>
                        <select onChange={(e) => setFuncao(e.target.value)} name="func-pessoa" className="form-control mx-auto" id="func-pessoa">
                            ...
                            <option value="Locatario_Normal">Locatario Normal</option>
                            <option value="Locatario_Diario">Locatario Diário</option>
                            <option value="Locatario_Mensal">Locatario Mensal</option>
                            <option value="Locatario_Anual">Locatario Anual</option>
                        </select>
                    </div>
                    <br />
                    <div className="form-group">
